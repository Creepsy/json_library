...
const std::string& json::json_object::get_string() const {
    if(!this->is_string()) throw std::runtime_error("JSON object isn't a string!");
    return *(std::string*)this->data;
}

const std::map<std::string, json::json_object>& json::json_object::get_map() const {
    if(!this->is_map()) throw std::runtime_error("JSON object isn't a map!");
    return *(std::map<std::string, json::json_object>*)this->data;
}

const std::vector<json::json_object>& json::json_object::get_array() const {
    if(!this->is_array()) throw std::runtime_error("JSON object isn't an array!");
    return *(std::vector<json::json_object>*)this->data;
}

double json::json_object::get_double() const {
    if(!this->is_double()) throw std::runtime_error("JSON object isn't a double!");
    return *(double*)this->data;
}

int64_t json::json_object::get_int() const {
    if(!this->is_int()) throw std::runtime_error("JSON object isn't an int!");
    return *(int64_t*)this->data;
}

bool json::json_object::get_bool() const {
    if(!this->is_bool()) throw std::runtime_error("JSON object isn't a boolean!");
    return *(bool*)this->data;
}

bool json::json_object::is_string() const {
    return this->object_type == value_type::STR;
}

bool json::json_object::is_map() const {
    return this->object_type == value_type::MAP;
}

bool json::json_object::is_array() const {
    return this->object_type == value_type::VEC;
}

bool json::json_object::is_double() const {
    return this->object_type == value_type::FP_NUM;
}

bool json::json_object::is_int() const {
    return this->object_type == value_type::INT_NUM;
}

bool json::json_object::is_bool() const {
    return this->object_type == value_type::BOOL;
}

bool json::json_object::is_null() const {
    return this->object_type == value_type::NONE;
}

std::ostream& json::json_object::pretty_print(std::ostream& stream, const size_t intendation_size, const bool whitespace, size_t intendation_count) const {
    switch(this->object_type) {
        ...
        case json::value_type::MAP:
            ...
            {
                size_t pos = 0;
                for(const std::pair<const std::string, json::json_object>& sub_obj : this->get_map()) {
                    if(pos != 0) {
                        stream << ", ";
                        if(whitespace) stream << std::endl;
                    }
...
std::ostream& json::operator<<(std::ostream& stream, const json_object& obj) {
